    ...
    <Row style={{ marginBottom: '1.5em' }}>
      <Col span={2}>
        ...
        {security.dailyChange && (
          <Title style={{ margin: 0 }} level={3} type={security.dailyChange > 0 ? 'success' : 'danger'}>
            {security.dailyChange > 0 ? '+' : ''}
            {security.dailyChange.toFixed(2)}%
          </Title>
        )}
      ...
      <Col span={3}>
        <Row gutter={[0, 0]}>
          ...
          <Col span={14} style={{ justifyContent: 'end', display: 'flex' }}>
            <Text strong>{currentPriceData.open.toFixed(2)}</Text>
          </Col>
        </Row>
        <Row gutter={[0, 0]}>
          <Col span={10} style={{ justifyContent: 'end', display: 'flex' }}>
          ...
          <Col span={14} style={{ justifyContent: 'end', display: 'flex' }}>
            <Text strong>{currentPriceData.high.toFixed(2)}</Text>
          </Col>
        </Row>
        <Row gutter={[0, 0]}>
          <Col span={10} style={{ justifyContent: 'end', display: 'flex' }}>
          ...
          <Col span={14} style={{ justifyContent: 'end', display: 'flex' }}>
            <Text strong>{currentPriceData.low.toFixed(2)}</Text>
          </Col>
        </Row>
        <Row gutter={[0, 0]}>
          <Col span={10} style={{ justifyContent: 'end', display: 'flex' }}>
          ...
          <Col span={14} style={{ justifyContent: 'end', display: 'flex' }}>
            <Text strong>{currentPriceData.volume}</Text>
          </Col>
        </Row>
      </Col>
    </Row>
